...
module.exports = class gate extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'name': 'Gate.io',
            'countries': [ 'KR' ],
            // cheapest endpoint is 5000 requests per second
            'rateLimit': 0.2, // 1000 / 5000 = 0.2
            'version': 'v4',
            'certified': true,
            'pro': true,
            'urls': {
            ...
            'api': {
                'public': {
                    'wallet': {
                        'get': {
                            'wallet/currency_chains': 25,
                        },
                    },
                    'spot': {
                        'get': {
                            'currencies': 6,
                            'currencies/{currency}': 6,
                            'currency_pairs': 6,
                            'currency_pairs/{currency_pair}': 6,
                            'tickers': 6,
                            'order_book': 6,
                            'trades': 6,
                            'candlesticks': 6,
                    ...
                    'futures': {
                        'get': {
                            '{settle}/contracts': 17,
                            '{settle}/contracts/{contract}': 17,
                            '{settle}/order_book': 17,
                            '{settle}/trades': 17,
                            '{settle}/candlesticks': 17,
                            '{settle}/tickers': 17,
                            '{settle}/funding_rate': 17,
                            '{settle}/insurance': 17,
                            '{settle}/contract_stats': 17,
                            '{settle}/liq_orders': 17,
                        },
                    },
                    'delivery': {
                        'get': {
                    ...
                    'options': {
                        'get': {
                            ...
                            'expirations': 17,
                            'contracts': 17,
                            'contracts/{contract}': 17,
                            'settlements': 17,
                            'settlements/{contract}': 17,
                            'order_book': 17,
                            'tickers': 17,
                            'underlying/tickers/{underlying}': 17,
                            'candlesticks': 17,
                            'underlying/candlesticks': 17,
                            'trades': 17,
                        },
                    },
                },
                'private': {
                    'withdrawals': {
                        'post': {
                            '': 15000, //  1 per 3 seconds
                        },
                        'delete': {
                            '{withdrawal_id}': 15000,
                        },
                    },
                    'wallet': { // all wallet endpoints 200 per second
                        'get': {
                            'deposit_address': 25,
                            'withdrawals': 25,
                            'deposits': 25,
                            'sub_account_transfers': 25,
                            'withdraw_status': 25,
                            'sub_account_balances': 25,
                            'fee': 25,
                            'total_balance': 25,
                        },
                        'post': {
                    ...
                    'spot': {
                        'get': {
                            ...
                            'my_trades': 6,
                            'price_orders': 6,
                            'price_orders/{order_id}': 6,
                        },
                        'post': { // 10 per second
                            'batch_orders': 500, // TODO orders counted towards ratelimiter individually
                            'orders': 500,
                            'cancel_batch_orders': 1, // TODO investigate 5000 per second
                            'price_orders': 500,
                        },
                        'delete': {
                            'orders': 1, // 5000 per second
                            'orders/{order_id}': 1, // 5000 per second
                            'price_orders': 1, // 5000 per second
                            'price_orders/{order_id}': 1, // 5000 per second
                        },
                    },
                    'margin': {
                        'get': {
                            ...
                            'loans': 6,
                            'loans/{loan_id}': 6,
                            'loans/{loan_id}/repayment': 6,
                            'loan_records': 6,
                            'loan_records/{load_record_id}': 6,
                            'auto_repay': 6,
                            'transferable': 6,
                            'cross/accounts': 6,
                            'cross/account_book': 6,
                            'cross/loans': 6,
                            'cross/loans/{loan_id}': 6,
                            'cross/loans/repayments': 6,
                            'cross/transferable': 6,
                            'loan_records/{loan_record_id}': 6,
                            'borrowable': 6,
                            'cross/repayments': 6,
                            'cross/borrowable': 6,
                        },
                        'post': { // 10 per second
                            'loans': 500,
                            'merged_loans': 500,
                            'loans/{loan_id}/repayment': 500,
                            'auto_repay': 500,
                            'cross/loans': 500,
                            'cross/loans/repayments': 500,
                            'cross/repayments': 500,
                        },
                        'patch': {
                            'loans/{loan_id}': 500,
                            'loan_records/{loan_record_id}': 500,
                        },
                        'delete': {
                            'loans/{loan_id}': 1,
                        },
                    ...
                    'futures': {
                        'get': {
                            '{settle}/accounts': 12.5,
                            '{settle}/account_book': 12.5,
                            '{settle}/positions': 12.5,
                            '{settle}/positions/{contract}': 12.5,
                            '{settle}/orders': 12.5,
                            '{settle}/orders/{order_id}': 12.5,
                            '{settle}/my_trades': 12.5,
                            '{settle}/position_close': 12.5,
                            '{settle}/liquidates': 12.5,
                            '{settle}/price_orders': 12.5,
                            '{settle}/price_orders/{order_id}': 12.5,
                            '{settle}/dual_comp/positions/{contract}': 12.5,
                        },
                        'post': {
                            '{settle}/positions/{contract}/margin': 50,
                            '{settle}/positions/{contract}/leverage': 50,
                            '{settle}/positions/{contract}/risk_limit': 50,
                            '{settle}/dual_mode': 50,
                            '{settle}/dual_comp/positions/{contract}': 50,
                            '{settle}/dual_comp/positions/{contract}/margin': 50,
                            '{settle}/dual_comp/positions/{contract}/leverage': 50,
                            '{settle}/dual_comp/positions/{contract}/risk_limit': 50,
                            '{settle}/orders': 50,
                            '{settle}/price_orders': 50,
                            '{settle}/batch_orders': 50, // TODO update calculateRateLimiterCost () each order in batch is ratelimited individually
                        },
                        'delete': {
                            '{settle}/orders': 12.5,
                            '{settle}/orders/{order_id}': 12.5,
                    ...
                    'options': {
                        'get': {
                            ...
                            'account_book': 12.5,
                            'positions': 12.5,
                            'positions/{contract}': 12.5,
                            'position_close': 12.5,
                            'orders': 12.5,
                            'orders/{order_id}': 12.5,
                            'my_trades': 12.5,
                        },
                        'post': {
                            'orders': 50,
